    ...
    <div class="reg" style="background-color:green;width: 400px;height:auto;margin-left:auto;margin-right:auto">
        <form action="edit" method="POST">
            ...
            <div style="padding-top:10px;">
                ...
                <input type="text" name="name" id="name" style="margin-left:auto;margin-right:auto;" value="${user.name}">

            </div>

            <div style="padding-top:10px;">
                <label for="surname" style="display: inline-block;width: 150px;text-align:right;">Surname</label>
                <input type="text" name="surname" id="surname" style="margin-left:auto;margin-right:auto;" value="${user.surname}">

            </div>
            <div style="padding-top:10px;">
                <label for="email" style="display: inline-block;width: 150px;text-align:right;">Email</label>
                <input type="text" name="email" id="email" style="margin-left:auto;margin-right:auto;" value="${user.email}">

            </div>
            <div style="padding-top:10px;">
                <label for="country" style="display: inline-block;width: 150px;text-align:right;">Country</label>
                <input type="text" name="country" id="country" style="margin-left:auto;margin-right:auto;" value="${user.address.countryName}">

            </div>

            <div style="padding-top:10px;">
                <label for="city" style="display: inline-block;width: 150px;text-align:right;">City</label>
                <input type="text" name="city" id="city" style="margin-left:auto;margin-right:auto;" value="${user.address.city}">
            </div>

            <div style="padding-top:10px;">
                <label for="address" style="display: inline-block;width: 150px;text-align:right;">Address</label>
                <input type="text" name="address" id="address" style="margin-left:auto;margin-right:auto;" value="${user.address.address}">
            </div>

            <div style="padding-top:10px;">
                <label for="postcode" style="display: inline-block;width: 150px;text-align:right;">Postcode</label>
                <input type="text" name="postcode" id="postcode" style="margin-left:auto;margin-right:auto;" value="${user.address.postcode}">
            </div>
